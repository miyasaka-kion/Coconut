...
public:
    ...
    TheoJansen(GameContext* gc) : m_gc(gc){
        ...
        {
            b2BodyDef bd;
            b2Body*   ground = gc->GetWorld()->CreateBody(&bd);
        ...
        // Chassis
        {
            ...
            m_chassis   = gc->GetWorld()->CreateBody(&bd);
...

        {
            ...
            bd.type     = b2_dynamicBody;
            bd.position = pivot + m_offset;
            m_wheel     = gc->GetWorld()->CreateBody(&bd);
...

        {
            ...
            m_motorJoint        = ( b2RevoluteJoint* )gc->GetWorld()->CreateJoint(&jd);
        }
